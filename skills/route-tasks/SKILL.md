...
| **(any other / unrecognized error)** | Write OPEN state with `failure_count=1`. Re-route this task to local_llm via Step 3. Log `⚠ HIGH PRIORITY` entry with full error text. |
